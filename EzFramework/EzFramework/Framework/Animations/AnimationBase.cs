...
{
    public class AnimationBase : ScreenBase 
    {
        ...
        public AnimationBase(string screenName) : base(screenName)
        {
        ...
        /// <param name="duration">Animation duration in milliseconds</param>
        /// <param name="end">Function is invoked when animation finishes</param>
        public void MoveTo(AnimationType animationType, int duration, Action end = null)
        {
